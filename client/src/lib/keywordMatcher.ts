...
const KEYWORD_MAP: Record<string, { type: MatchType; key?: string; projectSlugs?: string[] }> = {
  ...
  hershey: { type: 'project', projectSlugs: ['chocochill'] },
  chocochill: { type: 'project', projectSlugs: ['chocochill'] },
  'choco chill': { type: 'project', projectSlugs: ['chocochill'] },
  concept: { type: 'project', projectSlugs: ['chocochill'] },
  chocolate: { type: 'project', projectSlugs: ['chocochill'] },
  mockup: { type: 'project', projectSlugs: ['chocochill'] },
